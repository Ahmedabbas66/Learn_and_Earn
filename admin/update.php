...
if (isset($_POST['submit'])) {
   ...
   // Update National ID, Phone Number, and Gender
   if (!empty($nationalID)) {
      $update_nationalID = $conn->prepare("UPDATE `tutors` SET NationalID = ? WHERE id = ?");
      $update_nationalID->execute([$nationalID, $tutor_id]);
      $message[] = 'National ID updated successfully!';
   }

   if (!empty($phoneNumber)) {
      $update_phoneNumber = $conn->prepare("UPDATE `tutors` SET PhoneNumber = ? WHERE id = ?");
      $update_phoneNumber->execute([$phoneNumber, $tutor_id]);
      ...
      <form class="register" action="" method="post" enctype="multipart/form-data">
         ...
         <div class="flex">
            <div class="col">
               ...
               <p>National ID </p>
               <input value="<?= $fetch_profile['NationalID']; ?>" type="text" name="national_id" placeholder="<?= $fetch_profile['NationalID']; ?>" maxlength="20" required class="box">
               <p>Email </p>
               <input value="<?= $fetch_profile['email']; ?>" type="email" name="email" placeholder="<?= $fetch_profile['email']; ?>" maxlength="50" class="box">
               <p>Phone Number </p>
               <input value="<?= $fetch_profile['PhoneNumber']; ?>" type="tel" name="number" placeholder="<?= $fetch_profile['PhoneNumber']; ?>" maxlength="20" required class="box">
               <p>update pic :</p>
            ...
            <div class="col">
               ...
               <select name="gender" class="box" required>
                  <option value="<?= $fetch_profile['Gender']; ?>" selected><?= $fetch_profile['Gender']; ?></option>
