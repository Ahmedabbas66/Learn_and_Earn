...
//         }else{
//             $update_thumb = $conn->prepare("UPDATE exams SET thumb = ? WHERE id = ?");
    ...
    <section class="video-form">
        ...
        <input type="hidden" name="old_thumb" value="<?= $fecth_videos['thumb']; ?>">
            ...
            <textarea name="description" class="box" required maxlength="1000" cols="30"
                rows="10"><?= htmlspecialchars($exam['description']) ?></textarea>
            ...
            <input value="<?= htmlspecialchars($exam['duration']) ?>" type="number" name="duration" required
                class="box">
            ...
            <div id="componentContainer">
                ...
                <input value="<?= htmlspecialchars($question['text']) ?>" type="text"
                    name="questions[<?= $question['id'] ?>]" required class="box">
                <input type="hidden" name="original_questions[<?= $question['id'] ?>]"
                ...
                <div class="options">
                    ...
                    <div class="option">
                        <p>
                            <input type="radio" name="correct_option[<?= $question['id'] ?>]"
                                value="<?= $option['id'] ?>" <?= $option['is_correct'] ? 'checked' : '' ?>>
                            <?= $letter ?>
                        </p>
                        <input value="<?= htmlspecialchars($option['text']) ?>" type="text"
                            name="options[<?= $question['id'] ?>][<?= $option['id'] ?>]" class="box">
